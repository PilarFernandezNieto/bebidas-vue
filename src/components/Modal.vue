                ...
                <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                    <TransitionChild as="template" enter="ease-out duration-300"
                        ...
                        <DialogPanel
                            ...
                            <div>
                                <div class="mt-3">
                                    <DialogTitle as="h3" class="text-gray-900 text-4xl font-extr my-5">{{
                                        bebidas.receta.strDrink }}</DialogTitle>
                                    <img :src="bebidas.receta.strDrinkThumb" class="mx-auto w-96"
                                        :alt="'Imagen de ' - bebidas.receta.strDrink">
                                    <DialogTitle as="h3" class="text-gray-900 text-4xl font-extr my-5">Ingredientes y
                                        Cantidades</DialogTitle>
                                    <div v-html="formatearIngredientes().outerHTML"></div>
                                    <DialogTitle as="h3" class="text-gray-900 text-4xl font-extr my-5">Instrucciones
                                    </DialogTitle>
                            ...
                            <div class="mt-5 sm:mt-6 flex justify-between gap-4">
                                <button type="button" @click="modal.handleClickModal()"
                                    class="w-full rounded bg-gray-600 font-bold uppercase text-white shadow hover:bg-gray-500 p-3">Cerrar</button>
                                <button type="button" @click="favoritos.handleClickFavorito()"
                                    class="w-full rounded bg-orange-600 font-bold uppercase text-white shadow hover:bg-orange-500 p-3">{{ modal.textoBoton }}</button>
