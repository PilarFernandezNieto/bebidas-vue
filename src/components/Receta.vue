...
<template>
    <div class="border shadow-lg">
        ...
        <div class=" p-5">
            ...
            <button type="button" class="bg-orange-400 mt-5 w-full p-3 font-bold text-white text-lg hover:bg-orange-500"
                @click="bebidas.seleccionarBebida(receta.idDrink)">Ver Receta</button>
        </div>
